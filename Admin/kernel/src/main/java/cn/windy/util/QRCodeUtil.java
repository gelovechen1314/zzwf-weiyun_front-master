...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        String text = "http://cdz.chuizhijiaoyu.com/cdz/jump.jsp?vid=6409000200";
//        不含Logo
        QRCodeUtil.encode(text, null, "d:\\", true);
//        含Logo，不指定二维码图片名
        // QRCodeUtil.encode(text, "d:\\ydc.jpg", "d:\\qr2code", true);
//        含Logo，指定二维码图片名
        //QRCodeUtil.encode(text, "d:\\ydc.png", "d:\\二维码", "240a0b0101", true);

//
//        System.out.println(Long.parseLong("01000000",16));
//
//        System.out.println(Long.toHexString(16777216L));
    }
}